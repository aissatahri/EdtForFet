...
closeSuccessModal() {
  ...
  toggleAbsence(eleve: any): void {
    eleve.isAbsent = !eleve.isAbsent; // Toggle the isAbsent property
    this.atLeastOneChecked = this.classeEleves.some(classeeleve => classeeleve.eleve?.isAbsent); // Update the atLeastOneChecked state
  }
}
